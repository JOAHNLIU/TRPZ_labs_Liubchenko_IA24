...
class Archiver(Observable):
    ...
    def archive_component(self, component, db_manager, archive_id):
        component.archive(self, db_manager, archive_id)
        self.close()
        self.notify_observers("Archiving components completed")
